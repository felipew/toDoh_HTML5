...
steroids.config.name = "todoh"

# -- Initial Location --
steroids.config.location = "http://localhost/views/todo/index.html"
...
steroids.config.tabBar.tabs = [
  {
    title: "Main"
    icon: "icons/MenuSelected@2x.png"
    location: "http://localhost/views/todo/index.html"
  },
  {
    title: "About"
    icon: "icons/Help@2x.png"
    location: "http://localhost/views/todo/about.html"
  }
]

# steroids.config.tabBar.tintColor = "#000000"
# steroids.config.tabBar.tabTitleColor = "#00aeef"
steroids.config.tabBar.selectedTabTintColor = "#ff9900"
# steroids.config.tabBar.selectedTabBackgroundImage = "icons/pill@2x.png"

# steroids.config.tabBar.backgroundImage = ""

# -- Navigation Bar --
steroids.config.navigationBar.tintColor = "#ff9900"
